...
# 
# This code is safe to run and dosen't cause any harm before any of your actions  
# Go to 'main' function to understand the functioning properly 


#Inporting OS library 
import os
...
try:
    ...
    #  'The name of the fiel is already exists  .. '
...
try:
    # Here the code is tested sucessfully and here you dont get any error 
    #Try exceot function is used 
    def extension_remover(path, replacement, extension2):
        ...
        # or rename the files till any soecifies directory indexes
        print('\n These are the total number of files with your replacement,')
        print('Do you want to rename all (1 - yes , 2- no ) :  ')
        a = int(input('Enter the number :  '))
        if a == 1:  # Methid calling to rename all the files at once
            for filename in os.listdir(path):
        ...
        elif a == 2: # Method to rename picticular number of files 
...
except: # pasing any other error occouced
    pass
...
try:
    ...
    def random_rename(path, extension, filename, length):
        ...
        if extension in filename:
            ...
            my_source2 = my_source.replace(filename, '') # removing the orignal filename to replace the new one
...
# This fuction specifies you are going to use the 
# random rename fuctions .....   or the 
...
# This function control that which facality of the program you are going to use 
# 1. Changing the extension
# 2. Just renaming the file with the name of of convineance  
def main():
    logo()
    try:
        ec = 'Do you want to just rename the Extension of the file or just want to just change all the names ..'
        print(ec)
        # Input the facility of the progrma you want to use 
        ...
        if gh == 1: # Calling the extention change facility
            try:
            ...
            try:
                # Here input the extention of the files you enat to rename 
...
if __name__ == '__main__':
    while True:
        try:
            ...
            # to init() anll the facilities of the code 
            main()
